...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.setRobotDirection(int(random.random() * 360 % 360))
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        while not self.room.isPositionInRoom(position):
            direction = int(random.random() * 360 % 360)
            position = self.position.getNewPosition(direction, self.speed)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for t in range(num_trials):
        ...
        if t == 0:
            ...
            average_steps = (average_steps + steps) / 2.0
...
class RandomWalkRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        """
        while True:
            self.direction = int(random.random() * 360 % 360)
